...
public class ProductRessource {
    ...
    public Response getPaginatedProducts(
        ...
        Set<String> allowed = Set.of("id", "title", "slug", "publishedAt", "isActive", "seoTitle", "seoDescription");
        ...
        products = Product.findAll(sort).page(pageIndex, pageSize).list();
    ...
    public Response createProduct(CreateProduct createProduct) {
        ...
        product.persist();
        return product.id != null ? Response.ok().build()
